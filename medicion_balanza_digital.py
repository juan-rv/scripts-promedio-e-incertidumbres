...
# Datos de las mediciones de masa de los trozos de balso con la balanza digital (en gramos)
masas_trozos = np.array([1.4, 1.2, 1.1, 1.4, 1.3, 1.5, 1.3, 1.4, 1.3, 1.2])  # en gramos
...
# Paso 4: Calcular la incertidumbre de resolución (resolución de la balanza digital: 0.1 g)
resolucion_balanza_digital = 0.1  # resolución en gramos
incertidumbre_resolucion = resolucion_balanza_digital / (2 * math.sqrt(3))
